                                ...
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <?php 
                                            ...
                                            $stmt->execute();
                                            $stmt->store_result();                                          
                                            $stmt->bind_result($serviceid,$title);
                                            while ($stmt->fetch()) { 
                                        ?> 
                                        <tr class="even pointer">
                                            ...
                                            <td class="last"><a href="<?php echo SITE_URL; ?>/add_service?serviceid=<?php echo $serviceid; ?>" class="actionbtn1">Modify</a> <a onclick="return confirm('Are you sure?')" href="<?php echo SITE_URL; ?>/add_service?serviceid=<?php echo $serviceid; ?>&action=delete" class="deletebtn">Delete</a>
                                            </td>
                                        </tr>  
                                        <?php } ?>                
                                        </tbody>
