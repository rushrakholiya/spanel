                                        ...
                                        <tbody>
                                        	...
                                        	<?php 
                                                    ...
                                                    <tr class="even pointer">
                                                        ...
                                                        <td class=" "><?php echo get_service_name($mysqli,$service_id); ?></td>
		                                                ...
		                                                <td class=" last"><a href="javascript:void(0);" data-toggle="modal" data-target=".bs-example-modal-lg-<?php echo $app_registerid; ?>" class="actionbtn1">View</a> <a href="<?php echo SITE_URL; ?>/app_register?userid_mod=<?php echo $app_registerid; ?>" class="actionbtn2">Active It</a> <a onclick="return confirm('Are you sure?')" href="<?php echo SITE_URL; ?>/app_register?userid=<?php echo $app_registerid; ?>&serviceid=<?php echo $service_id; ?>&action=pdelete" class="deletebtn">Delete</a>
		                                                </td>
		                                            </tr>  
					                                    ...
					                                    <div class="modal-dialog modal-lg">
					                                        <div class="modal-content">
					                                            ...
					                                            <div class="modal-header">
					                                                ...
					                                                <h4 class="modal-title" id="myModalLabel">#<?php echo $app_registerid; ?></h4>
					                                            </div>
					                                            <div class="modal-body">
                    												...
                    												<div class="row">
                                                                     ...
                                                                     <?php 
                                                                    $id = $_REQUEST["userid"];
                                                                    $services = $mysqli->prepare("SELECT service_id, user_id, current_status, support_expiry_date FROM app_register_service_master WHERE user_id = '$app_registerid' AND current_status <> 1");
                                                                    $services->execute();
                                                                    $services->store_result();                  
                                                                    $services->bind_result($service_id, $user_id, $current_status, $support_expiry_date);
                                                                ?>                                                               
                                                                <div class="row">
                                                                        <div class="col-md-3 col-sm-3 col-xs-3">Inactive Services :</div>
                                                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                                                        <?php 
