                                ...
                                <div class="x_content">
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class="last"><a href="<?php echo SITE_URL; ?>/add_product?productid=<?php echo $productid; ?>" class="actionbtn1">Modify</a> <a onclick="return confirm('Are you sure?')" href="<?php echo SITE_URL; ?>/add_product?productid=<?php echo $productid; ?>&action=delete" class="deletebtn">Delete</a>
                                            </td>
                                        </tr>  
                                        <?php } ?>                
                                        </tbody>
